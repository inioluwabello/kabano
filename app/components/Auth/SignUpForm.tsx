...
import { signInWithGitHub, signInWithGoogle } from "@/lib/firebase/auth/sign-in";
...
export const SignUpForm = ({ setLoading }:
    ...
    const handleAuthResult = (error: any) => {
        setLoading(false);
        if (error) {
    ...
    return (
        <div className="form-wrapper">
            ...
            <div className="form-content">
                ...
                <p className="alt-text">Create an account to boost your productivity with <strong>Kabano</strong></p>
                ...
                <form onSubmit={handleForm} className="form">
                    ...
                    <button className="border btn pry-bg" type="submit">Sign Up</button>
                ...
                <p className="alt-text">Already have an account? {" "}
                    <span className="link pointer"
                        onClick={() => { router.push("/auth/sign-in") }}
                    ><strong>Sign In</strong></span></p>
